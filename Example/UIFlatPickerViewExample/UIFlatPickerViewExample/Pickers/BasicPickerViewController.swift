...
class BasicPickerViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        selectedValueLabel.text = "Selected: January"
    ...
    private func setupPicker() {
        ...
        pickerView.selectionIndicatorColor = .systemBlue
...
extension BasicPickerViewController: UIFlatPickerViewDataSource {
...
extension BasicPickerViewController: UIFlatPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIFlatPickerView, didSelectRow row: Int, inComponent component: Int) {
        selectedValueLabel.text = "Selected: \(months[row])"
